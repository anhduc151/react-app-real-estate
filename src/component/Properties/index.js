...
import img1 from '../../assets/img/index/glasnevin-dublin01.jpeg';
import img2 from '../../assets/img/index/glasnevin-dublin01.jpeg';
import img3 from '../../assets/img/index/templeogue-dublin01.jpeg';
import img4 from '../../assets/img/index/charlotte-quay-dublin01.jpeg';
import img5 from '../../assets/img/index/dingle01.jpeg';
import img6 from '../../assets/img/index/dingle01.jpeg';
  ...
  render() {
    return (
        ...
        <div className="text-right move-from-left mr-5 mb-3">
          <a href="local-properties.html">Tất cả dự án <i className="fas fa-long-arrow-alt-right ml-2" /></a>
        </div>
        <div className="content">
          <div className="row">
            <div className="col-md-6 col-lg-4">
              <div className="box">
                <img src={img1} className="img-fluid" alt="Doolin House, Dublin" />
                <div className="text">
                  <h3>
                  ...
                  <a href="projects.html" className="btn">Thêm dự án</a>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-4">
              <div className="box">
                <img src={img2} className="img-fluid" alt="Glasnevin, Dublin" />
                <div className="text">
            ...
            <div className="col-md-6 col-lg-4">
              <div className="box">
                <img src={img3} className="img-fluid" alt="Templeogue, Dublin" />
                <div className="text">
            ...
            <div className="col-md-6 col-lg-4 d-none d-md-block">
              <div className="box">
                <img src={img4} className="img-fluid" alt="Charlotte Quay Dublin" />
                <div className="text">
            ...
            <div className="col-md-6 col-lg-4 d-none d-md-block">
              <div className="box">
                <img src={img5} className="img-fluid" alt="Ventry, Dingle, Co Kerry" />
                <div className="text">
            ...
            <div className="col-md-6 col-lg-4 d-none d-md-block">
              <div className="box">
                <img src={img6} className="img-fluid" alt="Ventry, Dingle, Co Kerry" />
                <div className="text">
                  <h3>Ruby Residence Ngã Bảy</h3>
                  <span>7.500.000.000 đ</span>
                  <p className="text-left">Căn hộ, chung cư</p>
