...
export default class index extends Component {
  render() {
    return (
        ...
        <p className="text-center pr-4 pl-4">Tất cả các tài sản trên trang web này đang được bán theo hiệp ước riêng chứ không phải đấu giá.
          Ưu đãi không ràng buộc về mặt pháp lý cho đến khi hợp đồng được ký kết.</p>
      </div>
